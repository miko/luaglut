...
IMPLEMENT_WINCALLBACK_uci2 ( keyboardup        )
IMPLEMENT_WINCALLBACK_i3   ( special         )
IMPLEMENT_WINCALLBACK_i3   ( specialup         )
...
IMPLEMENT_SETWINCALLBACK ( KeyboardUp,         keyboardup          )
IMPLEMENT_SETWINCALLBACK ( Special,          special           )
IMPLEMENT_SETWINCALLBACK ( SpecialUp,          specialup           )
...
void register_glut(lua_State *L)
{
   ...
   FUN   (glutKeyboardUpFunc)
   FUN   (glutMouseFunc)
   FUN   (glutMotionFunc)
   FUN   (glutPassiveMotionFunc)
   FUN   (glutSpecialFunc)
   FUN   (glutSpecialUpFunc)
   FUN   (glutIdleFunc)
   FUN   (glutTimerFunc)
